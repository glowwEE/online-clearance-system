	...
	<div class="header-top">
		<div class="container">
			<div class="bottom_header_left">
				<p>
					<span class="fa fa-map-marker" aria-hidden="true"></span>AEFUNAI ,Ebonyi, Nigeria
				</p>
			</div>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">
							<h1>
								<span class="fa fa-leanpub" aria-hidden="true"></span>AE_FUNAI
								<label>Clearance System</label>
							</h1>
						</a>
					</div>
					<!--/.navbar-header-->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li class="active">
									<a href="./new/index.php" class="effect-3">Home</a>
								</li>
								<li>
									<a href="./new/about.php" class="effect-3">About Us</a>
								</li>
 
								<li>
									<a href="./new/contact.php" class="effect-3">Contact Us</a>
								</li>
							</ul>
						</nav>
					</div>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h6>Welcome To AE-FUNAI</h6>
						<h3>Home of
							<span>Soaring Eagles</span>
						</h3>
