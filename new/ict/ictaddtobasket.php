            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($idnumber && $basket)
						{
							$query=mysqli_query($con,"select * from department_ict where idnumber='$idnumber'");
							...
							{
								$update=mysqli_query($con,"update department_ict set basket='$basket',clearance_status='2' where idnumber='$idnumber'");
								if($update)
								{
