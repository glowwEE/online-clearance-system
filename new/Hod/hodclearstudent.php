            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$chk=mysqli_query($con,"select * from department_hod where incre='$incre' && basket=''");
							$no=mysqli_num_rows($chk);
							if($no==1)
							{
							$update=mysqli_query($con,"update department_hod set clearance_status='1',basket='' where incre='$incre'");
							if($update)
							{
