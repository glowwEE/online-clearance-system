                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($show)
						{
							...
							{
								 $ch=mysqli_query($con,"select * from department_hod where idnumber='$studentid'");
								 $hc=mysqli_fetch_array($ch);
								 $basket=$hc['basket'];
								 if($basket=='')
								 {
								 	$update=mysqli_query($con,"update department_hod set clearance_status='1',basket='' where idnumber='$studentid'");
									if($update)
									{
